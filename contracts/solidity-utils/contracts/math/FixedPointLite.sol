...
// import "./LogExpMathLite.sol";

/* solhint-disable private-vars-leading-underscore */

library FixedPointLite {
    ...
    function mulUp(uint256 a, uint256 b) internal pure returns (uint256 result) {
        ...
        // @note zk compiler is not a fan of this assembly
    ...
    /**
     * @dev Intrnal high precision (36 decimal places) natural logarithm (ln(x))
     * with signed 18 decimal fixed point argument, for x close to one.
     *
