...
import "../../interfaces/contracts/pool-utils/IRateProviderPool.sol";
import "../../pool-utils/contracts/external-fees/ProtocolFeeCache.sol";
  ...
  IRateProviderPool
{
  ...
  function _getRateFactor(
    ...
    return
      provider == IRateProvider(0) ? FixedPoint.ONE : provider.getRate().powDown(normalizedWeight);
  }
